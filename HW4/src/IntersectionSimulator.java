...
class IntersectionSimulator {
	...
	public static void simulate(
		...
		int htime = 0;
		for (int time = 0; !roadsempty; time += 1) {
			...
			System.out.printf("%8s%-24s%d %s\n", "", "Cars currently waiting: ", carsCurrentlyWaiting, "cars");
			...
			System.out.println();
			roadsempty = isection.isEmpty();
			
		}

		System.out.printf("%4s%s:\n", "", "simulation summary:".toUpperCase());
		System.out.printf("%8s%-24s%d %s\n", "", "Total time: ", htime, "cars");
		System.out.printf("%8s%-24s%d %s\n", "", "Total vehicles: ", totalCarsPassed, "cars");
		System.out.printf("%8s%-24s%d %s\n", "", "Longest wait time: ", longestWaitTime, "turns");
		System.out.printf("%8s%-24s%d %s\n", "", "Total wait time: ", totalWaitTime, "turns");
		System.out.printf("%8s%-24s%f %s\n", "", "Average wait time: ", (1.0 * 1/1), "turns");
