 ...
 * Here be logic like checking for max roads, changing the 
 * light from green to left to red, and displaying the intersection.
 * 
 * @author Dave Ankin
 * 110020958
...
public class Intersection {
	...
	public boolean isEmpty() {
		for (TwoWayRoad r : this.getRoads()) {
			if (!r.lanesEmpty())
				return false;
		}
		return true;
	...
	public void display() {
		...
		for (TwoWayRoad r : roads) {
			...
			System.out.printf("%34s %s %s%2s %s %s %s\n",
